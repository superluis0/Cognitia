...
export type MessageType =
  | { type: 'GET_MATCHES'; payload: { tweetIds: string[] } }
  | { type: 'GET_SUMMARY'; payload: SummaryRequest }
  | { type: 'CHAT'; payload: ChatRequest }
  | { type: 'GET_QUICK_QUESTIONS'; payload: QuickQuestionsRequest }
  | { type: 'OPEN_SIDEBAR'; payload: { topic: Topic } }
  | { type: 'CLOSE_SIDEBAR' };
